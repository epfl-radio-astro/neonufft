...
find_library(
    FFTWF_MULTITHREAD_LIBRARIES
    NAMES "fftw3f_threads" "fftw3f_omp"
    HINTS ${_FFTWF_PATHS}
    PATH_SUFFIXES "lib" "lib64"
    ${_FFTWF_DEFAULT_PATH_SWITCH}
)
...
find_package_handle_standard_args(FFTWF REQUIRED_VARS FFTWF_INCLUDE_DIRS FFTWF_LIBRARIES FFTWF_MULTITHREAD_LIBRARIES)
...
if(FFTWF_FOUND)
    ...
    set_property(TARGET FFTWF::FFTWF PROPERTY INTERFACE_LINK_LIBRARIES ${FFTWF_LIBRARIES} ${FFTWF_MULTITHREAD_LIBRARIES})
